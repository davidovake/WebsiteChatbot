  ...
  return (
    <FrontendRoot>
      ...
      <p>
        ...
        your cv in Overleaf can help you have a stand out cv . You can find a cv
        template on overleaf in here: (
      ...
      <p>
        ...
        correctly , for example : Java, Python (Advanced) , React( Beginner) do
        not put technologies that you are not familiar with as the technical
        interviewers will quick find out about your knowledge simply by asking
        you a few questions. ( Knowing how to write “Hello World” in 5 different
        languages doesn’t make you a coding wizard).
      </p>
      <p>
        The education part should be at the top remember to mention the modules
        you have studied , computer science degrees are pretty similar but you
        have optional modules that can make you look like the perfect candidate
        for the job you are applying for.
      </p>
      <p>
        Most of the times the recruiters and the technical interviewers will be
        interested in the projects you have done. Having a well structured
        ...
        go after your work experience. Mention the projects you have worked on,
        whether they were in a group or personal project and don’t forget to
      ...
      <p>
        ...
        your technical knowledge ability to think creatively and work in a team.
        Most of the hackathons are happening online at the moment and you can
      ...
      <p>
        ...
        with the new technologies coming on the market , news , trends and etc.
        Podcasts look good on your cv and can really motive you if you are
        pursing a career in technology.
      </p>
    </FrontendRoot>
  );
};
